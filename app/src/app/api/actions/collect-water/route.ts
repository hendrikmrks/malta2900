...
import { COLLECT_WATER_DURATION_MS, computeCollectDurationMs } from "@/lib/game";
...
export async function POST() {
  ...
  try {
    await startTimedAction({
      userId,
      type: "collect_water",
      requireInRegion: "spring",
      nearStationKey: "collect_water",
      durationMs: (player) =>
        computeCollectDurationMs({
          baseDurationMs: COLLECT_WATER_DURATION_MS,
