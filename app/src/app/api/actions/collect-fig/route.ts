...
import { COLLECT_FIGS_DURATION_MS, computeCollectDurationMs } from "@/lib/game";
...
export async function POST() {
  ...
  try {
    await startTimedAction({
      userId,
      type: "collect_figs",
      requireInRegion: "grove",
      nearStationKey: "collect_figs",
      durationMs: (player) =>
        computeCollectDurationMs({
          baseDurationMs: COLLECT_FIGS_DURATION_MS,
