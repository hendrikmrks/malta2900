...
import { COLLECT_WOOD_DURATION_MS, computeCollectDurationMs } from "@/lib/game";
...
export async function POST() {
  ...
  try {
    await startTimedAction({
      userId,
      type: "collect_wood",
      requireInRegion: "forest",
      nearStationKey: "collect_wood",
      durationMs: (player) =>
        computeCollectDurationMs({
          baseDurationMs: COLLECT_WOOD_DURATION_MS,
